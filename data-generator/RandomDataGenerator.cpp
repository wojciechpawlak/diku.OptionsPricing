...
public:
    ...
    void distribute_1()
    {
        ...
        while (currentNumOptions < totalValuations)
        {
            ...
            RandValuation val(maturity, 12, reversionRate, randYieldCurves.size(), false, noCashflows, onlyEuropean);
            addValuation(val, currentNumOptions);
        }
    ...
    void distribute_4()
    {
        ...
        while (currentNumOptions < (skewPercent / (real)100) * totalValuations)
        {
            ...
            RandValuation val(maturity, 12, reversionRate, randYieldCurves.size(), true, noCashflows, onlyEuropean);
            addValuation(val, currentNumOptions);
        }
    ...
    void distribute_5()
    {
        ...
        while (currentNumOptions < (skewPercent / (real)100) * totalValuations)
        {
            ...
            RandValuation val(100, 12, reversionRate_skew, randYieldCurves.size(), true, noCashflows, onlyEuropean);
            addValuation(val, currentNumOptions);
        }
    ...
    void distribute_6()
    {
        ...
        while (currentNumOptions < (skewPercent / (real)100) * totalValuations)
        {
            ...
            RandValuation val(maturity, 12, reversionRate_skew, randYieldCurves.size(), true, noCashflows, onlyEuropean);
            addValuation(val, currentNumOptions);
        }
